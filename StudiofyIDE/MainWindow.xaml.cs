...
namespace StudiofyIDE
{
    public sealed partial class MainWindow : WindowEx
    {
        ...
        private async void GetCurrentUserAccount()
        {
            ...
            var data = current.GetPropertyAsync(KnownUserProperties.DisplayName);
                        ...
                        foreach (ReleaseAsset Asset in Assets)
                        {
                            ...
                            else if (Asset.Name.EndsWith(".pfx"))
                            {
                                ...
                                if (pfx != null)
                                {
                                    ...
                                    string fileName = "StudiofyIDECertificate.cer";
            ...
            catch (Exception ex)
            {
                if(ex.GetType().Name.ToString() == "NotFoundException")
                {
                    ContentDialog exceptionDialog = new()
                    {
                        ...
                        Content = "Cannot find the source for StudiofyIDE.",
        ...
        private async void AboutItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (dialogResult == ContentDialogResult.Primary)
            {
                string url = "https://raw.githubusercontent.com/Studiofy/StudiofyIDE/canary/LICENSE";
